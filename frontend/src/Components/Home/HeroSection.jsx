    ...
    return (
        <div className='w-full p-3'>
            ...
            <div className='w-full p-1 text-center flex flex-col items-center mt-2 md:flex-row md:w-[95%]'>
                <h1 className='font-[300] mb-2 md:font-[350]'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iure hic aliquid a! Alias libero eaque ab, voluptatem aut esse nemo, illo, sunt fugit repudiandae molestias.</h1>
